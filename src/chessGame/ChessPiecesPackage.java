...
//        initializePiece(listOfPieces,new Queen(Color.BLACK, "BlackQueen.png", 5, 6));




        initializePiece(listOfPieces, whiteKing = new King(Color.WHITE, "whiteKing.png", 7, 7));
        initializePiece(listOfPieces, blackKing = new King(Color.BLACK, "blackKing.png", 4, 0));

        initializePiece(listOfPieces, new Queen(Color.BLACK, "BlackQueen.png", 5, 6));

        initializePiece(listOfPieces, new Pawn(Color.WHITE, "whitePawn.png", 1, 0));
